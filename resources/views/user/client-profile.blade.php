...
@section('content')
    ...
    <section class="col-lg-8 col-md-8 col-12" id="ord">
        ...
        @endif
        <form action="{{ route('client-request-create') }}"
            method="POST">
            @csrf
            ...
            <div class=" col-12 align-content-center" id="detelis">
                <div class="card p-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <button type="submit" class="col-12 p-2 m-2 log-btn">ارسال الطلبية </button>
                    ...
                    <form class="row g-3">
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="اسمك الكامل " aria-label="fName"
                                    aria-describedby="addon-wrapping" required value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <input type="email" class="form-control" placeholder="الايميل" aria-label="email"
                                    aria-describedby="addon-wrapping" required value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <input type="text" class="form-contro 1" placeholder="رقم الهاتف" aria-label="phone"
                                    aria-describedby="addon-wrapping" required value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <input type="text" class="form-control l" placeholder="العنوان" aria-label="add"
                                    aria-describedby="addon-wrapping" required value="" />
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="input-group">
                                <input type="text" class="form-control l" placeholder="سيرة ذاتية" aria-label="add"
                                    aria-describedby="addon-wrapping" required value="" />
                            </div>
                        </div>
    ...
    <script>
        ...
        function addRequestDetail() {
            ...
            var drug_image = document.getElementById("drug_image");
            var drug_title = document.getElementById("drug_title");
            var quantity = document.getElementById("quantity");
            var accept_alternative = document.getElementById("accept_alternative");
            var day = document.getElementById("day");
            var month = document.getElementById("month");
            var year = document.getElementById("year");
            var repeat_until = document.getElementById("repeat_until");
            var order_details_table = document.getElementById("order_details_table");

            var drug = {};
            var repeat_every = 0;

            if (drug_image.value != "") drug.drug_image = drug_image.value;
            else drug.drug_title = drug_title.value;

            drug.quantity = quantity.value;
            drug.accept_alternative = accept_alternative.value;
            drug.repeat_every = 0;
            if (year.value) drug.repeat_every += year.value * 360;
            if (month.value) drug.repeat_every += month.value * 30;
            if (day.value) drug.repeat_every += day.value;
            repeat_every = drug.repeat_every;
            drug.repeat_until = year.repeat_until;
            ...
            alert('new drug added success');

            order_details_table.innerHTML = order_details_table.innerHTML +
                "<div class='row'>" +
                "<div class='col-3'>" + drug_title.value + "</div>" +
                "<div class='col-3'>" + drug_image.value + "</div>" +
                "<div class='col-2'>" + quantity.value + "</div>" +
                "<div class='col-2'>" + accept_alternative.value + " </div>" +
                "<div class='col-2'>" + repeat_every + " </div>" +
                "</div>" +
                "<hr>";
        }
    </script>
