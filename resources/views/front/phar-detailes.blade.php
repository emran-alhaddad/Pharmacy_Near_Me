...
<section class="card" >
        ...
        <div class=" radius search-area">
            <img src="{{ asset('uploads/avaters/pharmacy/'.$pharmacy->avater)}}" class="radius" alt="Pharmacy Logo">
        </div>
    <div class="card-body">
        ...
        <ul class="social text-center d-flex align-content-center justify-content-center align-self-center col-12 py-3">
            ...
            <li class="btn-hover"><a href="javascript:void(0)"><i class="lni lni-instagram-filled pr-3"></i></a></li>
            <li class="btn-hover"><a href="javascript:void(0)"><i class="lni lni-linkedin-original pr-3"></i></a></li>
        </ul>
