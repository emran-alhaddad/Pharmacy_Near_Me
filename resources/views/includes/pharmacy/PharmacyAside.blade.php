<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme shadow  my-3 mb-4 rounded-3">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="{{ route('pharmacy-orders') }}" class="menu-link"><i class="bx bx-shopping-bag ms-2"></i>
                <div data-i18n="Account">ادارة الطلبات</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{ route('pharmacy-compliants') }}" class="menu-link"><i
                    class="bx bx-notification  ms-2"></i>
                <div data-i18n="Account">الشكاوي</div>
            </a>
        </li>

        <li class="menu-item">
            <a href="{{ route('pharmacy-account') }}" class="menu-link"><i class="bx bx-user ms-2"></i>
                <div data-i18n="Account">البروفايل</div>
            </a>
        </li>

        <li class="menu-item">
            <a href="{{ route('pharmacy-bag') }}" class="menu-link"><i class="bx bx-user ms-2"></i>
