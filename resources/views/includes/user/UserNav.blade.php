        ...
        <ul class="navbar-nav flex-row align-items-center me-auto">
            ...
            <li class="nav-item dropdown-notifications navbar-dropdown dropdown ms-3 ms-xl-1 ">
                ...
                <ul class="dropdown-menu dropdown-menu-start py-0 ">
                    ...
                    <li class="dropdown-notifications-list scrollable-container col-12" id="notifications_list">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 col-12 p-2" style="direction:rtl; text-align: right" id="parent-notification">
                                        <h6 class="col-12 "> 
