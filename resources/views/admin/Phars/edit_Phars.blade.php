...
<div class="wrapper bg-white">
    ...
    <form>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="city" id="exampleInputName">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" name="email" id="exampleFormControlInput1" placeholder="haneen@example.com">
            </div>
