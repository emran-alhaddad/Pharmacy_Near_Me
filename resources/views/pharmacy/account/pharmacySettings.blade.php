    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="pharmacy-settings.html"><i class="bx bx-cog me-1"></i> الاعدادات</a>
                </li>
            </ul>
            <!-- email -->
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group ">
                            <input
                                ...
                                class="form-control"
                                placeholder="usernam@example.com"
            ...
            <div class="card shadow mt-5">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                        <div class="form-password-toggle">
                        <label class="form-label" for="basic-default-password12">تأكيد كلمة السر الجديده  </label>
                        <div class="input-group"  style="direction:ltr">
                            <input
                            type="password"
                            class="form-control"
