                  ...
                  <form>
                    <div class="row">
                      <div class="input-group input-3">
                        <input type="email" placeholder="اسم المستخدم" class="input-control" required>
                     </div>
                      <div class="input-group input-3">
                      ...
                      <div class="input-group input-3">
                        <input type="password" placeholder="تاكيد كلمة المرور" class="input-control" required>
                     </div>
                     ...
                     <div class="input-group input-3">
                      <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                          <li><a class="dropdown-item" href="#">صيدلي</a></li>
