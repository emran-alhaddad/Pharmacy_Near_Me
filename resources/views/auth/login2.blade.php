              ...
              <div class="col-lg-6 x">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <form>
                    <div class="row">
                      <div class="input-group input-3">
                        <input type="email" placeholder="الايميل" class="input-control" required>
                     </div>
                      <div class="input-group input-3">
                         <input type="password" placeholder="كلمة المرور" class="input-control" required>
                      </div>
                 ...
                 <div class="container">
                      ...
                      <p class="small  pb-lg-2" style="margin-top: 1em;"><a class="text-muted" href="#!" style="color: var(--black);
                        text-decoration: none; font-size: 1.6rem;" >هل نسيت كلمة المرور؟</a></p>
                      <p>ليس لديك حساب سابق؟ <a href="#!" style="color: #0a58ca;" > سجل الان</a></p>
                    </div>
                    <p class="small" style="margin-bottom: -2em;color: var(--black);font-size: 1.6rem;">او يمكتك الدخول عبر </p>
