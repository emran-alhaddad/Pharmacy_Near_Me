        ...
        <div class="card mx-auto" style="max-width:400px">
            ...
            <div class="card-body p-4" style="height: 500px; overflow: auto;">
                ...
                <div class="d-flex align-items-baseline mb-4">
                    <div class="pe-2">
                        <div>
                            <div class="card card-text d-inline-block p-2 px-3 m-1 bg-primary text-white">3:00pm??</div>
                        </div>
                        <div>
                ...
                <div class="d-flex align-items-baseline text-end justify-content-end mb-4">
                    <div class="pe-2">
                        ...
                        <div>
                            <div class="card card-text d-inline-block p-2 px-3 m-1">see you later</div>
                        </div>

                        <div>
                            <div class="card card-text d-inline-block p-2 px-3 m-1 mb-4">Buy!</div>
                        </div>
                        <div>
                        </div>
                    </div>
